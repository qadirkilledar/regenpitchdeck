...
export default function InvestorReadyPitch() {
  ...
  const slides = [
    ...
    },
    {
      ...
      stat: "FIRST-MOVER ADVANTAGE IN TOKENIZED REAL ESTATE",
      visual: "MarketVisual",
    },
    {
      id: "revenue",
      ...
      points: [
        "<strong>Property Management & Portfolio Development</strong><br/>CoLiving, pod hotels, creative studios and events space leasing, for our existing creative community tenancy base. Currently 50 tenants with $200,000 ARR",
        "<strong>SPV Tokenisation Fees</strong><br/>0.5-1% of SPV minting costs, 0.5% transaction fees, staking/liquidity pool fees",
        "<strong>Portfolio Index Token</strong><br/>Yield farming: Staking unlocked Regen token powered by property SPV revenue yield. Allows buy-backs of SPV ownership tokens to grow internal property stake",
      ],
      stat: "MULTIPLE SCALABLE REVENUE STREAMS",
    ...
    },
    {
      ...
      stat: "READY TO SCALE WITH INSTITUTIONAL CAPITAL",
    ...
    },
    {
      ...
      stages: [
        {
          quarter: "Q3 2025",
          title: "LAUNCH",
          points: ["Platform launch", "First 3 properties", "25,000 users"],
        },
        {
          quarter: "Q4 2025",
          title: "EXPAND",
      ...
      stat: "$500M IN TOKENIZED ASSETS BY Q4 2026",
      ...
      team: [
        {
          name: "Miki Elson",
          title: "Founder & CEO",
          background: "Former VP at Blackstone Real Estate, Harvard MBA",
          icon: "ME",
        },
        {
          name: "Michael Hernandez",
          title: "CMO",
          background: "Ex-Google Blockchain, MIT Computer Science",
          icon: "MH",
        },
        {
          name: "Qadir Killedar",
          title: "CTO",
          background: "Former COO at JLL, 15 years in commercial real estate",
          icon: "QK",
        },
        {
          name: "Cosmic Caz",
          title: "CFO",
          background:
            "Securities law expert, previously at SEC and Goldman Sachs",
          icon: "CC",
        },
      ],
      stat: "85+ YEARS COMBINED RELEVANT EXPERIENCE",
      visual: "TeamVisual",
    },
    {
      id: "advisors",
      title: "ADVISORS & INVESTORS",
      subtitle: "Industry Leaders Supporting Our Vision",
      points: [
        "<strong>Dominic Ryder</strong> - Tokenomics and DeFi veteran: Alvara",
        "<strong>Mr Cang</strong> - Lead investor and fund management",
        "<strong>Eulan</strong> - London/Hong Kong RWA Source",
        "<strong>Kaz Elkholy</strong> - Real Estate Acquisition and Negotiation",
      ],
      stat: "STRONG NETWORK OF INDUSTRY EXPERTS",
      visual: "AdvisorsVisual",
    },
    {
      id: "investment",
      ...
      <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl relative">
        <div className="grid grid-cols-2 gap-2 sm:gap-4">
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-3 sm:p-4 md:p-6 aspect-square flex flex-col items-center justify-center text-center">
            ...
            <div className="text-xs sm:text-sm text-[#6B7554]/70">
              Verifiable NFT proof of ownership
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 relative">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="flex items-start">
              ...
              <div>
                <div className="text-sm sm:text-base font-bold mb-1 text-[#6B7554]">
                  Property Management
                </div>
                <div className="text-xs sm:text-sm text-[#6B7554]/70">
                  CoLiving, pod hotels, creative studios and events space
                  leasing. Currently 50 tenants with $200,000 ARR
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <div className="text-sm sm:text-base font-bold mb-1 text-[#6B7554]">
                  SPV Tokenisation Fees
                </div>
                <div className="text-xs sm:text-sm text-[#6B7554]/70">
                  0.5-1% of SPV minting costs, 0.5% transaction fees,
                  staking/liquidity pool fees
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#6B7554] text-white flex items-center justify-center mr-2 sm:mr-4 flex-shrink-0">
                <FaSeedling className="w-4 h-4 sm:w-5 sm:h-5" />
              </div>
              <div>
                <div className="text-sm sm:text-base font-bold mb-1 text-[#6B7554]">
                ...
                <div className="text-xs sm:text-sm text-[#6B7554]/70">
                  Yield farming: Staking unlocked Regen token powered by
                  property SPV revenue yield. Allows buy-backs of SPV ownership
                  tokens
                </div>
              </div>
            </div>
          ...
          <div className="mt-4 sm:mt-6 bg-[#6B7554] text-white rounded-lg sm:rounded-xl p-2 sm:p-4 text-center">
            <div className="text-sm sm:text-base font-bold">
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 relative">
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="flex items-start">
              ...
              <div>
                <div className="text-sm sm:text-base font-bold text-[#6B7554]">
                  Dominic Ryder
                </div>
                <div className="text-xs sm:text-sm text-[#6B7554]/70">
                  Tokenomics and DeFi veteran: Alvara
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <div className="text-xs sm:text-sm text-[#6B7554]/70">
                  Lead investor and fund management
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <div className="text-xs sm:text-sm text-[#6B7554]/70">
                  Real Estate Acquisition and Negotiation
                </div>
              </div>
            </div>
          </div>
    ...
    >
      ...
      <div className="relative min-h-screen">
        {slides.map((slide, index) => (
          ...
          >
            {/* Left side content */}
            <div className="w-full md:w-1/2 max-w-xl md:pr-8 mb-6 md:mb-0 mt-4 md:mt-0 overflow-y-auto max-h-[60vh] md:max-h-[80vh] scrollbar-hide">
              <div className="max-w-lg mx-auto md:mx-0">
                ...
                {slide.features && (
                  <div className="grid grid-cols-1 gap-2 sm:gap-4 mb-3 sm:mb-4 md:mb-6">
                    {slide.features.map((feature, i) => (
                      <div
                        key={i}
                        className="bg-white rounded-lg p-3 sm:p-4 shadow-sm flex items-start"
                      >
                ...
                {slide.stats && (
                  <div className="grid grid-cols-2 gap-2 sm:gap-4 mb-3 sm:mb-4 md:mb-6">
                    {slide.stats.map((stat, i) => (
                      <div
                        key={i}
                        className="bg-white rounded-lg p-2 sm:p-4 shadow-sm text-center"
                      >
                    ...
                    {slide.team.map((member, i) => (
                      ...
                      >
                        <div className="flex items-center mb-1 sm:mb-2">
                          <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#6B7554] text-white flex items-center justify-center mr-2 sm:mr-3 flex-shrink-0">
                            <div className="text-sm sm:text-base font-bold">
                              {member.icon}
                            </div>
                          </div>
                ...
                {/* Projections */}
                {slide.projections && deviceType === "mobile" && (
                  <div className="bg-white rounded-lg p-3 sm:p-4 shadow-sm mb-3 sm:mb-4 md:mb-6">
                    <div className="text-sm sm:text-base font-bold mb-2 sm:mb-3">
                      Financial Projections
                    </div>
                    <div className="space-y-2 sm:space-y-3">
                      {slide.projections.map((projection, i) => (
                        <div
                          key={i}
                ...
                {slide.cta && (
                  <div className={deviceType === "mobile" ? "text-center" : ""}>
                    <button className="px-6 sm:px-8 py-2 sm:py-3 bg-[#6B7554] text-white rounded-lg font-bold text-sm sm:text-base md:text-lg shadow-lg transform transition-all duration-300 hover:shadow-xl hover:bg-[#8A9B6A]">
                      {slide.cta}
                    </button>
                    {slide.contact && (
