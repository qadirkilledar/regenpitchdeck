          ...
          >
            ...
            <div className="w-full md:w-1/2 max-w-xl md:pr-8 mb-6 md:mb-0 overflow-y-auto max-h-[calc(100vh-8rem)] scrollbar-hide">
              <div className="max-w-lg mx-auto md:mx-0">
                ...
                {/* Advisors List */}
                {slide.advisors && !slide.team && (
                  <div className="grid grid-cols-1 gap-2 sm:gap-4 mb-3 sm:mb-4 md:mb-6">
                    {slide.advisors.map((advisor, i) => (
                      <div
                        key={i}
                        className="bg-[#6B7554]/5 rounded-lg p-3 sm:p-4"
                      >
                        <div className="flex items-center mb-2 sm:mb-3">
                          <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#6B7554] text-white flex items-center justify-center mr-2 sm:mr-3 flex-shrink-0">
                            <div className="text-sm sm:text-base font-bold">
...
// Existing visual components remain unchanged as they were not modified in this version
