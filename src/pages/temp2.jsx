...
export default function InvestorReadyPitch() {
  ...
  const slides = [
    ...
    },
    {
      ...
      advisors: "Backed by advisors from BlackRock, Coinbase, and JLL",
      visual: "TeamVisual",
    },
    {
      id: "advisors",
      ...
      <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg aspect-square relative">
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 relative overflow-hidden">
          <div className="absolute top-2 sm:top-4 right-2 sm:right-4 px-2 sm:px-3 py-1 bg-[#6B7554] text-white text-xs rounded-full">
            <span className="text-[10px] sm:text-xs">REVENUE STREAMS</span>
          </div>

          <div className="mt-8 sm:mt-12 grid grid-cols-1 gap-3 sm:gap-4">
            {slides
              .find((s) => s.id === "revenue")
  ...
  // Merged Team & Advisors Visual Component
  const TeamAndAdvisorsVisual = () => (
    <div className="relative flex items-center justify-center w-full h-full">
      <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg aspect-square relative">
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 relative">
          {/* Team Section */}
          <div className="text-base sm:text-lg md:text-xl font-bold mb-3 sm:mb-4 text-[#6B7554]">
            World-Class Team
          </div>
          <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-4 sm:mb-6">
            {slides
              ...
              .team.map((member, index) => (
                <div
                  key={index}
                  className="bg-[#6B7554]/10 rounded-lg sm:rounded-xl p-2 sm:p-3"
                >
                  <div className="flex items-center mb-1 sm:mb-2">
                    <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-[#6B7554] text-white flex items-center justify-center mr-2 flex-shrink-0">
                    ...
                    <div>
                      ...
                      <div className="text-[9px] sm:text-[10px] text-[#6B7554]/70">
                        {member.title}
                      </div>
                    </div>
                  </div>
          ...
          {/* Advisors Section */}
          <div className="text-sm sm:text-base md:text-lg font-bold mb-2 sm:mb-3 text-[#6B7554]">
            Strategic Advisors
          </div>
          <div className="grid grid-cols-1 gap-1 sm:gap-2 mb-3 sm:mb-4">
            {slides
              .find((s) => s.id === "advisors")
              .advisors.map((advisor, i) => (
                <div key={i} className="bg-[#6B7554]/10 rounded-lg p-2 sm:p-3">
                  <div className="flex items-center">
                    <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-[#6B7554] text-white flex items-center justify-center mr-2 flex-shrink-0">
                      <div className="text-xs sm:text-sm font-bold">
          ...
          {/* Bottom Stats */}
          <div className="bg-[#6B7554] text-white rounded-lg sm:rounded-xl p-2 sm:p-3 text-center">
            <div className="text-xs sm:text-sm font-bold">
              85+ Years Combined Experience • Industry Leaders Backing Our
              Vision
            </div>
          </div>
        </div>
          ...
          >
            ...
            <div className="w-full md:w-1/2 max-w-xl md:pr-8 mb-6 md:mb-0 overflow-y-auto max-h-[calc(100vh-8rem)] scrollbar-hide">
              <div className="max-w-lg mx-auto md:mx-0">
                ...
                {/* Combined Team & Advisors for Mobile */}
                {slide.team && deviceType === "mobile" && (
                  <div className="space-y-2 sm:space-y-4 mb-3 sm:mb-4 md:mb-6">
                    ...
                    <div className="bg-white rounded-lg p-2 sm:p-3 shadow-sm">
                      <div className="text-sm sm:text-base font-bold text-[#6B7554] text-center">
                        Strategic Advisors
                      </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg p-3 sm:p-4 shadow-sm text-center">
                      <div className="text-xs sm:text-sm font-medium text-[#6B7554]">
                        85+ Years Combined Experience • Industry Leaders Backing
                        Our Vision
                      </div>
                    </div>
                  </div>
                ...
                {slide.projections && (
                  <div className="bg-white rounded-lg p-3 sm:p-4 shadow-sm mb-3 sm:mb-4 md:mb-6">
                    ...
                    <FinancialChart data={slide.projections} />
                  </div>
                )}
